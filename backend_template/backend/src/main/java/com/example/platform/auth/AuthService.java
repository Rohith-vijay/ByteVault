...
public class AuthService {
    ...
    private final com.example.platform.email.EmailTemplateBuilder emailTemplateBuilder;

    @Transactional
    public AuthenticationResponse register(RegisterRequest request) {
        if (userRepository.findByEmail(request.getEmail()).isPresent()) {
            throw new com.example.platform.exception.DuplicateResourceException("Email already registered");
        }
        ...
        User user = User.builder()
                ...
                .role(userRole)
                .isActive(true) // local registration verification auto-activated for development. Can switch to false if email is mandatory.
                .authProvider(com.example.platform.user.AuthProvider.LOCAL)
                .build();
        ...
        try {
            ...
            emailService.sendEmail(user.getEmail(), "Welcome to our Platform", emailBody);
        } catch (Exception e) {
        ...
        return userRepository.findByEmail(email)
                .orElseGet(() -> {
                    User user = User.builder()
                            ...
                            .authProvider(com.example.platform.user.AuthProvider.GOOGLE)
                            .build();
                    ...
                    try {
                        ...
                        emailService.sendEmail(saved.getEmail(), "Welcome to our Platform", emailBody);
                    } catch (Exception e) {
    ...
    public AuthenticationResponse login(AuthenticationRequest request) {
        ...
        if (!user.isActive()) {
            throw new com.example.platform.exception.UnauthorizedException("Email not verified. Check your inbox.");
        }
